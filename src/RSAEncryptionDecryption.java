...
public class RSAEncryptionDecryption {
	...
	public static void main(String[] args) throws IOException 
		...
		try {
			...
			byte[] encryptedData = rsaObj.encryptData("TAGC");
			System.out.println("\nin main Encrypted"+encryptedData);
	...
	private byte[] encryptData(String data) throws IOException {
		...
		System.out.println("\n----------------ENCRYPTION STARTED------------");
		/*File file = new File("/home/yogi/Desktop/HPC_Project/encryption/1.txt");
		...
		try {
			...
			System.out.println("Encryted Data: " + encryptedData);			
                        ...
                        System.out.println("time taken by RSA: "+estimatedTime);			
